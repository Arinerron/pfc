...
public class ModuleSubdomain extends Module {
    ...
    public List<String> lookup(String domain) {
        ...
        livestring = "Scraping Google for subdomains...";
        ...
        livestring = "Scraping Ask for subdomains...";
        ...
        livestring = "Scraping DNSDumpster for subdomains...";
        try {
        ...
        livestring = "Scraping crt.sh for subdomains...";
        ...
        livestring = "Scraping Threatcrowd for subdomains...";
        ...
        livestring = "Scraping PassiveDNS for subdomains...";
         ...
         */
        if(bruteforce) {
            livestring = "Bruteforcing subdomains...";
            run = true;
